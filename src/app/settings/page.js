...
const configFields = [
    ...
    },
    {
        ...
        description: 'Target folder for document sync & output storage.',
        icon: HiOutlineCloud,
        type: 'text',
    },
    {
        ...
        description: 'Required for Google Picker (Drive Multi-Select). Create in Cloud Console.',
    ...
    },
    {
        ...
        description: 'Vector database endpoint for high-performance RAG.',
    ...
    },
    {
        ...
        placeholder: 'eyJhbG...',
        description: 'Anonymous key for Supabase access.',
        icon: HiOutlineKey,
        type: 'password',
    },
];
